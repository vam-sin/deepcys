...
for i in range(len(pdb)):
	print(i)
	inshell_proteins_single_5 = np.zeros(22, dtype = int) 
	inshell_proteins_single_6 = np.zeros(22, dtype = int) 
	inshell_proteins_single_7 = np.zeros(22, dtype = int) 
				...
				if residue1 != residue2:
					...
					if distance < 5: 
						if residue2.get_resname() == 'ALA':
							...
							inshell_proteins_single_5[20] += 1
						elif residue2.get_resname() == 'VAL':
							inshell_proteins_single_5[21] += 1
					if distance < 6:
						if residue2.get_resname() == 'ALA':
							...
							inshell_proteins_single_6[20] += 1
						elif residue2.get_resname() == 'VAL':
							inshell_proteins_single_6[21] += 1
					if distance < 7:
						if residue2.get_resname() == 'ALA':
							...
							inshell_proteins_single_7[20] += 1
						elif residue2.get_resname() == 'VAL':
							inshell_proteins_single_7[21] += 1
					if distance < 8:
						if residue2.get_resname() == 'ALA':
							...
							inshell_proteins_single_8[20] += 1
						elif residue2.get_resname() == 'VAL':
							inshell_proteins_single_8[21] += 1
